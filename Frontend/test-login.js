...
(async () => {
  ...
  try {
    ...
    console.log('✍️ Rellenando el formulario de login...');
    ...
    try {
      ...
      console.warn('⚠️ No hubo redirección, verificando si el login aún fue exitoso...');
    }
    ...
    try {
      ...
      console.error('⚠️ Error: No se encontró el dashboard. Puede que el login haya fallado.');
    }
